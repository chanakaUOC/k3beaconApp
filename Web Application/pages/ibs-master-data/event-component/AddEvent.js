...
class AddEvent extends Component {
    ...
    constructor(props) {
        super(props)
        this.state = { event_name: '', validate_message: '' }
    ...
    addInsurer(newInsurer, e) {
        axios.post(ApiList.pd_event_create, newInsurer)
            .then((response) => {
    ...
    onSubmit(e) {
        ...
        if (event_name.length > 0) {
            const newInsurer = { event_name: event_name, user_id: 1 }
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>     <input
                                                    ...
                                                    name="event_name" ref="event_name"
                                                    placeholder= {this.props.master_page_tittle}
                                                    autoSave={false}
                                                    id="txt_event_name"></input>
                                                </td>
